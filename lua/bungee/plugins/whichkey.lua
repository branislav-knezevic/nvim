...
local mappings = {
  ["1"] = { "<cmd>1gt<CR>", "1st Tab" },
  ["2"] = { "<cmd>2gt<CR>", "2nd Tab" },
  ["3"] = { "<cmd>3gt<CR>", "3rd Tab" },
  ["4"] = { "<cmd>4gt<CR>", "4th Tab" },
  ["5"] = { "<cmd>5gt<CR>", "5th Tab" },
  ["q"] = { "<cmd>q<CR>", "Quit" },
  ...
  g = {
    ...
    b = { "<cmd>GBranches<cr>", "Git branches" },
    t = { "<cmd>GTags<cr>", "Git tags" },
